...
\par \uwave{正文字號雖定義為 10 pt，而實際上是 9 pt 系列。} \verb+\mag 913 + 
...
\begin{lstlisting}[firstnumber=306]
...
\begin{lstlisting}[firstnumber=467]
%PageStyle for dvips
	\else
...
\begin{lstlisting}[firstnumber=600]
\newcommand{\part}{%
...
\begin{lstlisting}[firstnumber=707]
...
\begin{lstlisting}[firstnumber=768]
...
\begin{lstlisting}[firstnumber=797]
...
\begin{lstlisting}[firstnumber=810]
...
\begin{lstlisting}[firstnumber=827]
...
\begin{lstlisting}[firstnumber=866]
...
\begin{lstlisting}[firstnumber=909]
...
\begin{lstlisting}[firstnumber=922]
\if@enablejfam
...
\begin{lstlisting}[firstnumber=972]
...
\begin{lstlisting}[firstnumber=1135]
\newdimen\endnotesep
...
\begin{lstlisting}[firstnumber=1187]
